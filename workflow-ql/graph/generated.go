...
import (
	...
	"github.com/boomitti/workflow-ql/graph/model"
...
type ComplexityRoot struct {
	Mutation struct {
		CreateWorkflow func(childComplexity int) int
	}
...
type MutationResolver interface {
	CreateWorkflow(ctx context.Context) (*model.Workflow, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createWorkflow":
		...
		return e.complexity.Mutation.CreateWorkflow(childComplexity), true
...
func (ec *executionContext) _Mutation_createWorkflow(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().CreateWorkflow(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNWorkflow2ᚖgithubᚗcomᚋboomittiᚋworkflowᚑqlᚋgraphᚋmodelᚐWorkflow(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_workflows(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Workflow)
	fc.Result = res
	return ec.marshalNWorkflow2ᚕᚖgithubᚗcomᚋboomittiᚋworkflowᚑqlᚋgraphᚋmodelᚐWorkflowᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNWorkflow2githubᚗcomᚋboomittiᚋworkflowᚑqlᚋgraphᚋmodelᚐWorkflow(ctx context.Context, sel ast.SelectionSet, v model.Workflow) graphql.Marshaler {
	return ec._Workflow(ctx, sel, &v)
}

func (ec *executionContext) marshalNWorkflow2ᚕᚖgithubᚗcomᚋboomittiᚋworkflowᚑqlᚋgraphᚋmodelᚐWorkflowᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Workflow) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNWorkflow2ᚖgithubᚗcomᚋboomittiᚋworkflowᚑqlᚋgraphᚋmodelᚐWorkflow(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNWorkflow2ᚖgithubᚗcomᚋboomittiᚋworkflowᚑqlᚋgraphᚋmodelᚐWorkflow(ctx context.Context, sel ast.SelectionSet, v *model.Workflow) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
